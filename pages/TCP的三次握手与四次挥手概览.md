...
- # MAC帧的MTU和TCP的MSS
	...
	- ## MSS的协商方式
		- 处于以上考虑，一般为了避免一个TCP帧的大小超过MTU长度导致IP报文丢失的概率增加，TCP在三次握手时通常还会协商MSS的长度。
		- 一般在三次握手时通过**SYN帧的MSS可选项字段**互相通知
			- 双方会以双方通告的MSS的**最小值**来确定MSS
		- 一般来说，MSS的设置会根据链路层的MTU来选择，例如，在以太网环境下，MSS为1500-20(IP头大小)-20(TCP头大小)=1460
- # SYN攻击和其避免方式
